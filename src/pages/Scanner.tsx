...
const fakeData: FakeRecord[] = [
  ...
  { apt: "APT-BlackFalcon", category: "Domain", value: "command-center.org" },
  { apt: "APT-NeonOtter",    category: "Hash",   value: "e1f2d3c4b5a697887766554433221100" },
  ...
  { apt: "APT-MapleShade",   category: "Hash",   value: "b4f0d2a1c9e8476a8d3f1b2c4e5a6789" },

 
  { apt: "APT-GlassWhale",   category: "Hash",   value: "c2a9f8b6e4d3c1a0f9b8e7d6c5a4b3f2" },

  
  { apt: "APT-EmberLyre",    category: "Hash",   value: "9f8d7c6b5a4e3d2c1b0a9f8e7d6c5b4a" },

  { apt: "APT-CopperFang",   category: "IP",     value: "172.31.5.9" },
  { apt: "APT-CopperFang",   category: "Domain", value: "copper-fang.org" },
  { apt: "APT-CopperFang",   category: "Hash",   value: "4a3b2c1d0e9f8a7b6c5d4e3f2a1b0c9d" },
  ...
  { apt: "APT-DriftEagle",   category: "Hash",   value: "0f1e2d3c4b5a69788796a5b4c3d2e1f0" },

 
  { apt: "APT-MarbleHound",  category: "Hash",   value: "fa12bc34de56ab78cd90ef12ab34cd56" },

  { apt: "APT-VelvetMoth",   category: "Hash",   value: "abcdef1234567890fedcba0987654321" }
...
const Scanner = () => {
  ...
  return (
    <div style={{ padding: "2rem", fontFamily: "monospace", background: "#111", color: "#0f0", minHeight: "100vh" }}>
      ...
      <h1 style={{ marginBottom: "1rem" }}>WARNING: DO NOT NAVIGATE TO ANY OF THESE IPS OR SITES, WE ARE NOT LIABLE FOR MALICIOUS CONNECTIONS</h1>
      <input
        type="text"
